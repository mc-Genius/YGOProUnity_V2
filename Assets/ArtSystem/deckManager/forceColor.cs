...
public class forceColor : MonoBehaviour {
	...
	void Start () {
        ...
        Color c;
        UnityEngine.ColorUtility.TryParseHtmlString(Config.Getui("allUI.color"), out c);
        ...
        UnityEngine.ColorUtility.TryParseHtmlString(Config.Getui("List.color"), out c);
        ...
        UnityEngine.ColorUtility.TryParseHtmlString(Config.Getui("lable.color"), out c);
        ...
        UnityEngine.ColorUtility.TryParseHtmlString(Config.Getui("lable.color.fadecolor"), out c);
